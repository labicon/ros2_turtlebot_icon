...
class sub_redis_node(Node):
    def __init__(self, bot_name, save_path):
        ...
        self.subscription1 = self.create_subscription(
            CompressedImage, f'/{bot_name}/D435_1/color/image_raw/compressed', self.rgb_image_callback, qos_profile_sensor_data)
        self.subscription2 = self.create_subscription(
            Image, f'/{bot_name}/D435_1/aligned_depth_to_color/image_raw', self.depth_image_callback, qos_profile_sensor_data)
